...
def start_watcher():
    ...
    def watch_loop():
        print(f"Watcher started: monitoring {DOCS_DIR}, {TEMPLATES_DIR}, {STATIC_SRC_DIR} for changes...")
...
def setup_server(docs_dir: Path, dist_dir: Path, templates_dir: Path, static_src_dir: Path, dev_mode: bool = False):
